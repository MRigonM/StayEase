...
using PropertyService.Application.Settings;
using PropertyService.Application.Utility;
using PropertyService.Domain;
using PropertyService.Domain.DTOs;
using PropertyService.Domain.Entities;
using PropertyService.Domain.Interfaces.Repositories;
using PropertyService.Domain.Interfaces.Services;
...
public class PropertyService : IPropertyService
{
    private readonly IUnitOfWork _unitOfWork;
        ...
        public PropertyService(IUnitOfWork unitOfWork, IMapper mapper, IConfiguration configuration)
        {
        ...
        public async Task<Responses> UpdatePropertyAsync(string propertyId, PropertyToUpdateDTO propertyDTO)
        {
            ...
            property.NightPrice = (decimal)propertyDTO.NightPrice;
